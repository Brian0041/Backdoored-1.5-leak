...
public final class GluProjection
{
    ...
    public enum ClampMode
    {
        ...
        private static final /* synthetic */ ClampMode[] $VALUES;
        
        public static ClampMode[] values() {
            return ClampMode.$VALUES.clone();
        }
        
        public static ClampMode valueOf(final String name) {
            return Enum.valueOf(ClampMode.class, name);
        }
        
        static {
            $VALUES = new ClampMode[] { ClampMode.ORTHOGONAL, ClampMode.DIRECT, ClampMode.NONE };
        }
    }
    ...
    public static class Projection
    {
        ...
        public enum Type
        {
            ...
            static {
                $VALUES = new Type[] { Type.INSIDE, Type.OUTSIDE, Type.INVERTED, Type.FAIL };
            }
        }
    }
}
