...
public class RenderUtils
{
    ...
    public static void circleESP(final BlockPos blockPos, final double radius, final Color color) throws Exception {
        final double renderPosX = (double)ObfuscationReflectionHelper.getPrivateValue((Class)RenderManager.class, (Object)Globals.mc.func_175598_ae(), new String[] { "renderPosX", "field_78725_b" });
        final double renderPosY = (double)ObfuscationReflectionHelper.getPrivateValue((Class)RenderManager.class, (Object)Globals.mc.func_175598_ae(), new String[] { "renderPosY", "field_78726_c" });
        final double renderPosZ = (double)ObfuscationReflectionHelper.getPrivateValue((Class)RenderManager.class, (Object)Globals.mc.func_175598_ae(), new String[] { "renderPosZ", "field_78723_d" });
    ...
    public static void glStart() {
        ...
        GL11.glEnable(2884);
        GL11.glDisable(2929);
        final double renderPosX = Globals.mc.func_175598_ae().field_78730_l;
        final double renderPosY = Globals.mc.func_175598_ae().field_78731_m;
        final double renderPosZ = Globals.mc.func_175598_ae().field_78728_n;
        GL11.glPushMatrix();
    ...
    public static AxisAlignedBB getBoundingBox(final BlockPos pos) {
        return Globals.mc.field_71441_e.func_180495_p(pos).func_185900_c((IBlockAccess)Globals.mc.field_71441_e, pos).func_186670_a(pos);
    }
